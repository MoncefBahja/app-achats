...
if (isset($_POST['women_subcategory'])) {

    $women_subcategory = $_POST['women_subcategory'];
    $gender = "women";
    ...
    $stmt = $conn->prepare("
            ...
            WHERE s.name = :women_subcategory 
            AND c.gender = :gender
            ORDER BY p.created_at DESC
        ");
    $stmt->bindParam(':women_subcategory', $women_subcategory);
    ...
    exit;
} else if (isset($_POST['women_category'])) {
