...
$numberOfResults = $conn->prepare("SELECT *
FROM products
INNER JOIN categories ON products.category_id = categories.id
WHERE categories.gender = 'women' ") ;
...
FROM products
INNER JOIN categories ON products.category_id = categories.id
WHERE categories.gender = 'women' LIMIT " .$resultsPerPage. " OFFSET " .( $page-1)*$resultsPerPage) ;
$results -> execute() ;
...
if($page == $count ) {
  ...
  " href="women.php?page=<?php echo $count ?>"><?php echo $count ?> </a>
    <?php
}
else { ?>
